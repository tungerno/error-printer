package de.vwgis.fis.views.admin;
...
import de.vwgis.fis.data.SampleBook;
import de.vwgis.fis.services.SampleBookService;
...
@PageTitle("Admin")
@Route(value = "admin-/:sampleBookID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class AdminView extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "admin-/%s/edit";
    ...
    public AdminView(SampleBookService sampleBookService) {
